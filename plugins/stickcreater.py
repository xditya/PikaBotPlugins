...
@ItzSjDude(outgoing=True, pattern="stcr ?(?:(.*?) \| )?(.*)")
async def sticklet(event):
    ...
    await event.client.send_file(event.chat_id, image_stream, caption="Created By PikaBot", reply_to=event.message.reply_to_msg_id)
    # cleanup
    try:
        os.remove(FONT_FILE)
    except:
